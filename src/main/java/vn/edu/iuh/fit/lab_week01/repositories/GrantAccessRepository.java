...
public class GrantAccessRepository {
    ...
    public List<GrantAccess> getGrantAccessForCustomer(String tenRole) {
        ...
        try {
            ...
            preparedStatement.setString(1, tenRole);
...
//        List<GrantAccess> grantAccesses = grantAccessRepository.getGrantAccessForCustomer();
//        for (GrantAccess g :
//                grantAccesses) {
