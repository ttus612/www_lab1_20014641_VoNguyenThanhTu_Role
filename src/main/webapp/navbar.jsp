                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="add-account?page=addAccount&action=addAccount">Add account</a></li>
                            <li><a class="dropdown-item" href="list-account?page=listAc&action=listAccount">List account</a></li>
                            <li><a class="dropdown-item" href="list-of-permissions?page=listPer&action=listPermission">List account of a role</a></li>
                            <li><a class="dropdown-item" href="list-permissions-of-an-account?page=listPerOfAnAccount&action=listPerOfAnAccountAction">List permissions of an account</a></li>
